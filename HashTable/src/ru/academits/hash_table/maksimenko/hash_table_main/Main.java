package ru.academits.hash_table.maksimenko.hash_table_main;

import ru.academits.hash_table.maksimenko.hash_table.HashTable;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(namesTable.size());
